...
from PyQt5.QtWidgets import (
    ...
    QMenuBar, QAction, QFileDialog, QTabWidget, QMessageBox, QInputDialog)
...
class BukuApp(QMainWindow):
    ...
    def autoFill(self):
        self.judulInput.setText("Contoh Judul")
        self.pengarangInput.setText("Nama Pengarang")
        self.tahunInput.setText("2025")
